...
void main() {
  ...
  setUp(() {
    ...
    dataSource = MovieRemoteDataSourceImpl(nc: mockNetworkClient);
  });
  ...
  group('get Now Playing Movies', () {
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      when(mockIOClient.get(Uri.parse('$kBaseUrl/movie/now_playing?$kApiKey')))
          .thenAnswer((_) async =>
  ...
  group('get Popular Movies', () {
    ...
    test('should return list of movies when response is success (200)',
      ...
      // arrange
      when(mockNetworkClient.client).thenAnswer((_) async => mockIOClient);
      when(mockIOClient.get(Uri.parse('$kBaseUrl/movie/popular?$kApiKey')))
          .thenAnswer((_) async =>
  ...
  group('get Top Rated Movies', () {
    ...
    test('should return list of movies when response code is 200 ', () async {
      // arrange
      when(mockNetworkClient.client).thenAnswer((_) async => mockIOClient);
      when(mockIOClient.get(Uri.parse('$kBaseUrl/movie/top_rated?$kApiKey')))
          .thenAnswer((_) async =>
  ...
  group('get movie detail', () {
    ...
    test('should return movie detail when the response code is 200', () async {
      // arrange
      when(mockNetworkClient.client).thenAnswer((_) async => mockIOClient);
      when(mockIOClient.get(Uri.parse('$kBaseUrl/movie/$tId?$kApiKey')))
          .thenAnswer((_) async =>
