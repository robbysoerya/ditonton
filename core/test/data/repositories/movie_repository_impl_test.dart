...
void main() {
  ...
  group('Now Playing Movies', () {
    ...
    test('should check if data connection checker is online or offline',
        () async {
      //act
    ...
    test(
        'should return SSL failure when the call to remote data source with invalid certificate',
        () async {
      // arrange
      when(mockRemoteDataSource.getNowPlayingMovies())
  ...
  group('Popular Movies', () {
    ...
    test(
        'should return SSL failure when call to data source with invalid certificate',
        () async {
      // arrange
      when(mockRemoteDataSource.getPopularMovies())
          .thenThrow(const TlsException());
